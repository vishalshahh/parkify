import { FormTypeCreateGarage } from '@parkify/forms/src/createGarage'
import { ViewState } from '@parkify/util/types'
...
import { SlotType } from '@parkify/network/src/gql/generated'
